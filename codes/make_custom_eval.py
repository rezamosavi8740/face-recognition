...
def create_verification_csv(root_dir, output_csv, num_pairs_per_person=None, negative_ratio=1, max_iters=None):
    all_images = []
    person_to_images = {}
    ...
    for images in person_to_images.values():
        ...
        if num_pairs_per_person is not None:
    ...
    while len(negative_pairs) < num_negative_pairs:
        print("positive_pairs size : " + str(num_negative_pairs))
        print("negative_pairs size now: " + str(len(negative_pairs)))
...
create_verification_csv(root_dir, output_csv, num_pairs_per_person=num_pairs_per_person,
                        negative_ratio=negative_ratio, max_iters=max_iters)
